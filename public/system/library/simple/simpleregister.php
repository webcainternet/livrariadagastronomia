...
class SimpleRegister extends Simple {
    ...
    public function loadSimpleSession() {
        if ($this->request->server['REQUEST_METHOD'] == 'GET') {
            ...
            if (!empty($this->session->data['shipping_address']['postcode']) && empty($this->session->data['simple']['register']['postcode'])) {
            ...
            if (!empty($this->session->data['shipping_address']['country_id']) && empty($this->session->data['simple']['register']['country_id'])) {
            ...
            if (!empty($this->session->data['shipping_address']['zone_id']) && empty($this->session->data['simple']['register']['zone_id'])) {
